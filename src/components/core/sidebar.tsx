...
import { navigationItems, appItems } from "@/constants/navigation";
import { ThemeToggle } from "@/components/ui/theme-toggle"; // Assuming ThemeToggle manages its own dark mode state
...
const Sidebar = () => {
  // const [activeItem, setActiveItem] = useState("Dashboard"); // Remove activeItem state
  ...
  return (
    <>
      ...
      {isSidebarExpanded ? (
        <MainSidebar
          // activeItem={activeItem} // Remove activeItem prop
          // setActiveItem={setActiveItem} // Remove setActiveItem prop
