...
import { Calendar as CalendarComponent } from "@/components/ui/calendar"; // Calendar for date picker
...
const AdminOrderManagement = () => {
  ...
  useEffect(() => {
    ...
    fetchAllOrders();
  }, [token, router, startDate, endDate]);
        ...
        >
          <Card className="mb-8 p-4 sm:p-6">
            <div className="flex flex-col sm:flex-row gap-4 items-center justify-between">
              ...
              {/* Filters and Refresh */}
              <div className="flex flex-col sm:flex-row gap-3 items-center w-full max-w-[800px]">
                {/* Order Status Filter */}
